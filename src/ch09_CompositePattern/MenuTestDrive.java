...
public class MenuTestDrive {
	...
	public static void main(String[] args) {
		...
		// we’re using the “composite” add() method to add each menu to the top level menu
		...
		dinerMenu.add(new MenuItem("Hotdog", "A hot dog, with saurkraut, relish, onions, topped with cheese",
								false, 3.05));
		dinerMenu.add(new MenuItem("Steamed Veggies and Brown Rice", "Steamed vegetables over brown rice",
								true, 3.99));
		dinerMenu.add(new MenuItem("Pasta", "Spaghetti with Marinara Sauce, and a slice of sourdough bread",
								true, 3.89));

		// and we’re also adding a sub-menu to a menu
