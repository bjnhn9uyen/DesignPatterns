...
public class ProductTransfer {
	...
	public ProductTransfer(int factoryType) {
		this.productDAO = DAOFactory.getDAOFactory(factoryType).getProductDAO();
	}

	public void createProductTable(Scanner scanner) throws SQLException {
		productDAO.createTable();
		pressEnterToContinue(scanner, "Product table created successfully!");
	}

	public void deleteProductTable(Scanner scanner) throws SQLException {
		productDAO.deleteTable();
		pressEnterToContinue(scanner, "Product table deleted successfully!");
	}
